...
public class MyToggleButton extends View {
    ...
    public void setup(AttributeSet attrs) {
        ...
        offBorderColor = typedArray.getColor(R.styleable.MyToggleButton_tb_offBorderColor, offBorderColor);
        onColor = typedArray.getColor(R.styleable.MyToggleButton_tb_onColor, onColor);
        spotColor = typedArray.getColor(R.styleable.MyToggleButton_tb_spotColor, spotColor);
        offColor = typedArray.getColor(R.styleable.MyToggleButton_tb_offColor, offColor);
        borderWidth = typedArray.getDimensionPixelSize(R.styleable.MyToggleButton_tb_borderWidth, borderWidth);
        defaultAnimate = typedArray.getBoolean(R.styleable.MyToggleButton_tb_animate, defaultAnimate);
        typedArray.recycle();
